...
import it.acsi.cycling.races.security.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.GET, "/api/races/**").permitAll()
            .antMatchers(HttpMethod.GET, "/api/_search/races/**").permitAll()
            .antMatchers(HttpMethod.GET, "/api/race-subscriptions/**").permitAll()
            .antMatchers(HttpMethod.POST , "/api/race-subscriptions").permitAll()
