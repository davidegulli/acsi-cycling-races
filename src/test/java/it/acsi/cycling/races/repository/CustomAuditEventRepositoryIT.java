...
import it.acsi.cycling.races.config.audit.AuditEventConverter;
import it.acsi.cycling.races.domain.PersistentAuditEvent;
...
import static it.acsi.cycling.races.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
